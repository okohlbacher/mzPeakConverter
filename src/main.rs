...
/// `bruker:trace-sort-dedup` (a Bruker device trace stored out of time order or with repeated
/// samples was put in time order, each exact (time, value) repeat kept once).

...
/// TOF lane's integer intensities become the 32-bit floats the peak list held; the m/z array is the
/// one the reader rebuilds from the TOF axis (with the spectrum's own `tof_c0`/`tof_c1`), as for
/// the peak list.
